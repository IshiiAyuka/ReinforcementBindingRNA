...
def main():
    ...
    output_path = "/home/slab/ishiiayuka/M2/Decoder/weights/t30_150M_decoder_NAR_after_reinforce_ppi3d_1103.pt"
        ...
        for step in range(max_steps):
            ...
            if (step % PRINT_SAMPLES_EVERY_STEP == 0):
                ...
                for i, (seq, r, ro, re) in enumerate(zip(
                    ...
                    print(f"[gen] batch={batch_idx:04d} step={step:06d} idx={i:02d} loss={float(loss.detach().cpu()):.5f} len={len(seq):4d}  {preview}{tail}", flush=True)
